...
1. [O que é um Load Balancer](#1-o-que-é-um-load-balancer)
    
2. [Por que usar Load Balancers](#2-por-que-usar-load-balancers)
    
3. [Arquitetura básica](#3-arquitetura-básica)
    
4. [Tipos de Load Balancers](#4-tipos-de-load-balancers)
    
5. [Load Balancer de camada 4](#5-load-balancer-de-camada-4)
    
6. [Load Balancer de camada 7](#6-load-balancer-de-camada-7)
    
7. [Load Balancer interno e externo](#7-load-balancer-interno-e-externo)
    
8. [Load Balancer de hardware e software](#8-load-balancer-de-hardware-e-software)
    
9. [Load Balancer gerenciado em nuvem](#9-load-balancer-gerenciado-em-nuvem)
    
10. [DNS Load Balancing](#10-dns-load-balancing)
    
11. [Global Load Balancing](#11-global-load-balancing)
    
12. [Algoritmos de Load Balancing](#12-algoritmos-de-load-balancing)
    
13. [Round Robin](#13-round-robin)
    
14. [Weighted Round Robin](#14-weighted-round-robin)
    
15. [Least Connections](#15-least-connections)
    
16. [Weighted Least Connections](#16-weighted-least-connections)
    
17. [Least Response Time](#17-least-response-time)
...
21. [IP Hash](#21-ip-hash)
    
22. [Power of Two Choices](#22-power-of-two-choices)
    
23. [Health Checks](#23-health-checks)
    
24. [Active e Passive Health Checks](#24-active-e-passive-health-checks)
    
25. [Session Affinity](#25-session-affinity)
    
26. [Sticky Sessions](#26-sticky-sessions)
    
27. [Stateless Applications](#27-stateless-applications)
    
28. [Load Balancer e TLS](#28-load-balancer-e-tls)
    
29. [Reverse Proxy e Load Balancer](#29-reverse-proxy-e-load-balancer)
    
30. [Load Balancer e API Gateway](#30-load-balancer-e-api-gateway)
    
31. [Load Balancer e Service Discovery](#31-load-balancer-e-service-discovery)
    
32. [Load Balancing em Kubernetes](#32-load-balancing-em-kubernetes)
    
33. [Escalando o próprio Load Balancer](#33-escalando-o-próprio-load-balancer)
    
34. [Alta disponibilidade](#34-alta-disponibilidade)
    
35. [Load Balancing e bancos de dados](#35-load-balancing-e-bancos-de-dados)
    
36. [Exemplo com C#](#36-exemplo-com-c)
    
37. [Exemplo com SQL Server](#37-exemplo-com-sql-server)
    
38. [Trade-offs](#38-trade-offs)
    
39. [Gargalos e limitações](#39-gargalos-e-limitações)
    
40. [Observabilidade](#40-observabilidade)
    
41. [Segurança](#41-segurança)
    
42. [Custos](#42-custos)
    
43. [Arquitetura de exemplo](#43-arquitetura-de-exemplo)
    
44. [Checklist de produção](#44-checklist-de-produção)
    
45. [Regras práticas](#45-regras-práticas)
    
46. [Questões de entrevista](#46-questões-de-entrevista)
    
47. [Exercício prático](#47-exercício-prático)
...
**Vídeo recomendado:** [Load Balancer - Conceitos e Funcionamento (YouTube)](https://www.youtube.com/watch?v=OIw0kWQwGis)
