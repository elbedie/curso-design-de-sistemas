# Módulo 6 — Conceitos Adicionais e Padrões de Arquitetura
...
**Leitura complementar:** [CQRS (Command Query Responsibility Segregation) em uma Arquitetura de Microsserviços](https://medium.com/sicreditech/cqrs-command-query-responsibility-segregation-em-uma-arquitetura-de-micro-servi%C3%A7os-71dcb687a8a9)
...
**Leitura complementar:** [Saga Pattern para Microservices](https://dev.to/thiagosilva95/saga-pattern-para-microservices-2pb6)
